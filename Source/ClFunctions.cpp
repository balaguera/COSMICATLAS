...
// ######################################################################
// ######################################################################
void gal2equ(healpix_real b, healpix_real l, healpix_real *ra, healpix_real *dec){
    healpix_real alpha_p=fac*192.859508;                        /*Right ascention of galactic north pole in radians*/
    healpix_real delta_p=fac*27.128336;                         /*Declination of galactic north pole in radians*/
    healpix_real l_n   =fac*122.932;                           /*Galactic longitude of the celestial pole, in radians*/
    healpix_real delta=sin(b*fac)*sin(delta_p)+cos(b*fac)*cos(delta_p)*cos(fac*l-l_n);
    *dec=asin(delta);
    healpix_real alpha1=sin(fac*l-l_n);
    healpix_real alpha2=cos(fac*l-l_n)*sin(delta_p)-tan(fac*b)*cos(delta_p);
...
void Cl_FUNCTIONS::get_eCl(int iz, int jz, vector<healpix_real>cli,vector<healpix_real>clj, vector<healpix_real>&ecl){
...
// *******************************************************************************************************************************************************
// *******************************************************************************************************************************************************
void Cl_FUNCTIONS::get_map(char c, string file_type, Healpix_Map<healpix_real>&map){
...
// *******************************************************************************************************************************************************
void Cl_FUNCTIONS::Cat2Map(char c, Healpix_Map<healpix_real>&map){
...
// *******************************************************************************************************************************************************
// *******************************************************************************************************************************************************
void Cl_FUNCTIONS::Cat2Map_noz(char c, Healpix_Map<healpix_real>&map){
...
void Cl_FUNCTIONS::Cat2Map_delta(char c, Healpix_Map<healpix_real>&map){
  int ira=(c=='r'? this->i_alpha_ran:this->i_alpha);
  int idec=(c=='r'? this->i_delta_ran:this->i_delta);
  int iz=(c=='r'? this->i_z_ran:this->i_z);
  int ncols=(c=='r'? this->n_columns_ran:this->n_columns_gal);
...
// *******************************************************************************************************************************************************
// *******************************************************************************************************************************************************
void Cl_FUNCTIONS::Map2Alm(Healpix_Map<healpix_real>map, Alm<xcomplex <healpix_real> >&alm,  Alm<xcomplex <healpix_real> >&Ilm, arr<arr<healpix_real> >&Jlm){
...
void Cl_FUNCTIONS::Map2Alm(Healpix_Map<healpix_real>map, Alm<xcomplex <healpix_real> >&alm){
...
void Cl_FUNCTIONS::Map2Ilm_Jlm(Alm<xcomplex <healpix_real> >&Ilm){
...
// *******************************************************************************************************************************************************
// *******************************************************************************************************************************************************
void Cl_FUNCTIONS::Map2Jlm(Healpix_Map<healpix_real>&map_ran){
...
void  Cl_FUNCTIONS::Alm2Cl(int iz, int jz,  Alm<xcomplex <healpix_real> >&Ilm, vector<healpix_real> &Cl){
...
void Cl_FUNCTIONS::Cl_bins(vector<healpix_real>Cl,  vector<healpix_real>&Clbin){
...
// *******************************************************************************************************************************************************
void Cl_FUNCTIONS::eCl_bins(vector<healpix_real>Cl,  vector<healpix_real>&Clbin){
...
// ######################################################################
// ######################################################################
healpix_real Cl_FUNCTIONS::get_min(char c, int ii){
...
// ######################################################################
// ######################################################################
healpix_real Cl_FUNCTIONS::get_max(char c, int ii ){
  vector<real_prec> pro=(c=='d'? this->  prop  :this->  prop_r);
  int ncols=(c=='d'? this->n_columns_gal:this->n_columns_ran);
  real_prec ZX=-100;
  real_prec zmx;
...
void Cl_FUNCTIONS::get_zbins_same_ngal(int nbins, int iiz, healpix_real zmn, healpix_real zmx, vector<vector<healpix_real> >&zzv){
