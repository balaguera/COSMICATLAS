...
namespace Constants
{
  ...
  const double Gravitational_constant = 6.673e-20; /*units (km)³ /kg/s²*/
  const double Solar_mass             = 1.988e30; /*in kg*/
  const double proton_mass            = 1.6726e-27; /*in kg*/
  const double Boltzmann_constant     = 1.3806503e-28; /*in (km)² kg /s²/K*/
  const double mean_mol_weight        = 0.59;
  const double kev                    = 1.602e-24; /*One Kiloelectronvolt in Kg km²/s²*/
  //const double RR                      = 8.0  ;    /*Scale in Mpc/h used to compute the variance in the mnass dstribution*/
