...
//  Params params;
 ...
 public:
  ...
  Catalog():logdeltaVMAX(0),logdeltaM(0),logdeltaM_low(0),var_prop(0),mean_Mass(0),mean_number_density(0),min_halo_separation(0),NOBJS(0){}
  //////////////////////////////////////////////////////////
  /**
   * @brief  Constructor
   */
  
 Catalog(Params _params, string _type_of_object):params (_params), type_of_object(_type_of_object), logdeltaVMAX(0),logdeltaM(0),logdeltaM_low(0),var_prop(0),mean_Mass(0),mean_number_density(0),min_halo_separation(0),NOBJS(0)
  {
...
//////////////////////////////////////////////////////////
  /**
   * @brief Read input catalog in binary format, with x, y, z in three separate files of lenght n
   */
...
#else
  void read_catalog_bin(ULONG n, string fx, string fy, string fz); // reads binary from fastpm
#endif

  //////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////
  /**
   * @brief Get the interpolated prop-density and write to output_file
   * @bried prop can be _MASS_, _COUNTS_
   */
